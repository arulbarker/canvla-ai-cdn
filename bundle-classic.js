    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const T = {
            id: {
                ...
                'nav.section-editing': 'AI Editing',
                ...
                'home.s2d': '88 tema di 16 kategori — dari Hutan Berkabut sampai Bayangan Jendela. Atau tulis prompt sendiri di Studio Kustom.',
                'home.s3': 'Proses',
                ...
                'cat.cloud-inversion.name': 'Lautan Awan Puncak',
                'cat.cloud-inversion.desc': 'Pindah ke puncak gunung di atas lautan awan — wajah tetap asli',
                'cat.blue-hour-env.name': 'Blue Hour Senja',
                'cat.blue-hour-env.desc': 'Suasana langit biru senja usai matahari terbenam — wajah tetap asli',
                'cat.ultra-wide.name': 'Ultra-Wide 0.5x',
                'cat.ultra-wide.desc': 'Perspektif lensa ultra-wide 0.5x smartphone — subjek tetap asli',
                'cat.dslr-portra.name': 'DSLR Portra 85mm',
                'cat.dslr-portra.desc': 'Bokeh 85mm f/1.8 + grading Kodak Portra 400 — subjek tetap asli',
                'cat.window-shadow.name': 'Bayangan Jendela',
                'cat.window-shadow.desc': 'Cahaya matahari hangat + bayangan kisi jendela — subjek tetap asli',
                'wiz.step-extra': 'Prompt Tambahan (Opsional)',
                ...
                'preset.lotr-sunrise': 'Fajar Fantasi LOTR',
                'preset.film-noir': 'Film Noir',
                'preset.scifi-blue': 'Biru Dingin Sci-Fi',
                'preset.wes-anderson': 'Pastel Wes Anderson',
                'preset.epic-hdr': 'Drama Epik HDR',
                'preset.western-dusty': 'Koboi Berdebu',
                'preset.horror-desat': 'Horor Pudar',
                'preset.kodak-cinema': 'Sinema Kodak Vision3',
                'preset.fuji-cinema': 'Sinematik Fujifilm',
                'preset.dramatic-relight': 'Pencahayaan Dramatis',
                'preset.dense-fog': 'Kabut Tebal',
                'preset.dense-warm-fog': 'Kabut Tebal Hangat',
                'preset.foggy-forest': 'Hutan Berkabut',
                'preset.enchanted-emerald': 'Zamrud Ajaib',
                'preset.rainforest': 'Hutan Hujan Tropis',
                'preset.autumn-amber': 'Hutan Musim Gugur',
                'preset.misty-pine': 'Pagi Pinus Berkabut',
                'preset.jungle-moss': 'Lumut Rimba Dalam',
                'preset.warm-foggy-forest': 'Hutan Kabut Hangat',
                'preset.moody-rainforest': 'Hutan Hujan Dramatis',
                'preset.golden-sunrise': 'Fajar Keemasan',
                'preset.sunset-glow': 'Rona Senja',
                'preset.honey-tone': 'Nuansa Madu Hangat',
                'preset.amber-backlight': 'Cahaya Belakang Amber',
                ...
                'preset.smoky-shadow': 'Bayangan Berasap',
                'preset.charcoal-fade': 'Pudar Arang',
                'preset.forest-noir': 'Noir Hutan Kelam',
                'preset.emerald-noir': 'Noir Zamrud',
                'preset.twilight-spectrum': 'Senja Usai Hujan',
                'preset.moody-green-cinema': 'Sinema Hijau Dramatis',
                'preset.kodak-portra': 'Kodak Portra',
                'preset.fuji-velvia': 'Fuji Velvia',
                'preset.cinestill-night': 'CineStill Malam',
                'preset.vhs-retro': 'Retro VHS',
                'preset.polaroid-soft': 'Polaroid Lembut',
                'preset.faded-70s': 'Pudar 70-an',
                'preset.sepia-classic': 'Sepia Klasik',
                'preset.kodachrome-64': 'Kodachrome 64',
                'preset.cyberpunk-neon': 'Neon Cyberpunk',
                'preset.tokyo-night': 'Malam Jalanan Tokyo',
                'preset.neon-noir': 'Neon Noir',
                'preset.city-teal': 'Kilau Teal Kota',
                'preset.hongkong-haze': 'Kabut Hong Kong',
                'preset.sodium-street': 'Lampu Jalan Oranye',
                'preset.rainy-neon': 'Pantulan Neon Hujan',
                'preset.korean-soft': 'Nuansa Lembut Korea',
                'preset.ig-clean': 'Cerah Bersih IG',
                'preset.pastel-cream': 'Krem Pastel Lembut',
                'preset.airy-minimal': 'Putih Minimalis',
                'preset.natural-skin': 'Warna Kulit Natural',
                'preset.cafe-tone': 'Estetik Kafe',
                'preset.cream-beige': 'Editorial Krem Beige',
                'preset.classic-mono': 'Monokrom Klasik',
                'preset.high-contrast-bw': 'Hitam Putih Kontras Tinggi',
                'preset.soft-gray': 'Film Abu Lembut',
                'preset.dramatic-portrait-bw': 'Potret Hitam Putih Dramatis',
                'preset.street-doc': 'Dokumenter Jalanan',
                'preset.misty-morning': 'Pagi Berkabut',
                'preset.rainy-mood': 'Suasana Hari Hujan',
                'preset.winter-snow': 'Salju Musim Dingin',
                'preset.spring-fresh': 'Mekar Musim Semi',
                'preset.stormy-drama': 'Drama Langit Badai',
                'preset.overcast-soft': 'Mendung Lembut',
                'preset.tropical-vibrant': 'Tropis Cerah',
                'preset.ocean-teal': 'Teal Samudra',
                'preset.nordic-cold': 'Dingin Nordik',
                'preset.bali-jungle': 'Rimba Bali',
                'preset.alpine-crisp': 'Segar Pegunungan Alpen',
                'preset.safari-warm': 'Safari Hangat',
                'preset.santorini': 'Biru Putih Santorini',
                'preset.warm-appetizing': 'Hangat Menggugah',
                'preset.bright-commercial': 'Komersial Cerah',
            ...
            en: {
                ...
                'home.s2d': '88 themes across 16 categories — from Foggy Forest to Window Light Shadow. Or write your own in Custom Studio.',
                'home.s3': 'Generate',
                ...
                'cat.cloud-inversion.name': 'Cloud Inversion',
                'cat.cloud-inversion.desc': 'Move to a mountaintop above a sea of clouds — face stays intact',
                'cat.blue-hour-env.name': 'Blue Hour',
                'cat.blue-hour-env.desc': 'Deep-blue twilight just after sunset — face stays intact',
                'cat.ultra-wide.name': 'Ultra-Wide 0.5x',
                'cat.ultra-wide.desc': '0.5x ultra-wide smartphone lens perspective — subject stays intact',
                'cat.dslr-portra.name': 'DSLR Portra 85mm',
                'cat.dslr-portra.desc': '85mm f/1.8 bokeh + Kodak Portra 400 grade — subject stays intact',
                'cat.window-shadow.name': 'Window Light Shadow',
                'cat.window-shadow.desc': 'Warm sunlight with window-lattice shadows — subject stays intact',
                'wiz.step-extra': 'Additional Prompt (Optional)',
                'cat.custom.name': 'Custom Studio',
                'cat.custom.desc': 'Write your own grading prompt',
                'preset.teal-orange': 'Teal & Orange Blockbuster',
                'preset.lotr-sunrise': 'LOTR Fantasy Sunrise',
                'preset.film-noir': 'Film Noir',
                'preset.scifi-blue': 'Sci-Fi Cool Blue',
                'preset.wes-anderson': 'Wes Anderson Pastel',
                'preset.epic-hdr': 'Epic Drama HDR',
                'preset.western-dusty': 'Western Dusty',
                'preset.horror-desat': 'Horror Desaturated',
                'preset.kodak-cinema': 'Kodak Vision3 Cinema',
                'preset.fuji-cinema': 'Fujifilm Cinematic',
                'preset.dramatic-relight': 'Dramatic Relight',
                'preset.dense-fog': 'Dense Fog',
                'preset.dense-warm-fog': 'Dense Warm Fog',
                'preset.foggy-forest': 'Foggy Forest',
                'preset.enchanted-emerald': 'Enchanted Emerald',
                'preset.rainforest': 'Tropical Rainforest',
                'preset.autumn-amber': 'Autumn Amber Woods',
                'preset.misty-pine': 'Misty Pine Morning',
                'preset.jungle-moss': 'Deep Jungle Moss',
                'preset.warm-foggy-forest': 'Warm Foggy Forest',
                'preset.moody-rainforest': 'Moody Rainforest',
                'preset.golden-sunrise': 'Golden Sunrise',
                'preset.sunset-glow': 'Sunset Glow',
                'preset.honey-tone': 'Honey Warm Tone',
                'preset.amber-backlight': 'Amber Backlight',
                ...
                'preset.smoky-shadow': 'Smoky Shadow',
                'preset.charcoal-fade': 'Charcoal Fade',
                'preset.forest-noir': 'Deep Forest Noir',
                'preset.emerald-noir': 'Emerald Noir',
                'preset.twilight-spectrum': 'After-Rain Twilight',
                'preset.moody-green-cinema': 'Moody Green Cinema',
                'preset.kodak-portra': 'Kodak Portra',
                'preset.fuji-velvia': 'Fuji Velvia',
                'preset.cinestill-night': 'Cinestill Night',
                'preset.vhs-retro': 'VHS Retro',
                'preset.polaroid-soft': 'Polaroid Soft',
                'preset.faded-70s': '70s Faded',
                'preset.sepia-classic': 'Sepia Classic',
                'preset.kodachrome-64': 'Kodachrome 64',
                'preset.cyberpunk-neon': 'Cyberpunk Neon',
                'preset.tokyo-night': 'Tokyo Street Night',
                'preset.neon-noir': 'Neon Noir',
                'preset.city-teal': 'City Teal Glow',
                'preset.hongkong-haze': 'Hong Kong Haze',
                'preset.sodium-street': 'Streetlight Sodium',
                'preset.rainy-neon': 'Rainy Neon Reflections',
                'preset.korean-soft': 'Korean Soft Tone',
                'preset.ig-clean': 'IG Clean Bright',
                'preset.pastel-cream': 'Soft Pastel Cream',
                'preset.airy-minimal': 'Airy White Minimal',
                'preset.natural-skin': 'Natural Skin Tone',
                'preset.cafe-tone': 'Cafe Aesthetic',
                'preset.cream-beige': 'Cream Beige Editorial',
                'preset.classic-mono': 'Classic Monochrome',
                'preset.high-contrast-bw': 'High Contrast B&W',
                'preset.soft-gray': 'Soft Gray Film',
                'preset.dramatic-portrait-bw': 'Dramatic Portrait B&W',
                'preset.street-doc': 'Street Documentary',
                'preset.misty-morning': 'Misty Morning',
                'preset.rainy-mood': 'Rainy Day Mood',
                'preset.winter-snow': 'Winter Snow Cool',
                'preset.spring-fresh': 'Spring Fresh Bloom',
                'preset.stormy-drama': 'Stormy Sky Drama',
                'preset.overcast-soft': 'Overcast Soft',
                'preset.tropical-vibrant': 'Tropical Vibrant',
                'preset.ocean-teal': 'Ocean Teal',
                'preset.nordic-cold': 'Nordic Cold',
                'preset.bali-jungle': 'Bali Jungle',
                'preset.alpine-crisp': 'Alpine Crisp',
                'preset.safari-warm': 'Safari Warm',
                'preset.santorini': 'Santorini Blue White',
                'preset.warm-appetizing': 'Warm Appetizing',
                'preset.bright-commercial': 'Bright Commercial',
        ...
        const CATEGORIES = [
            ...
            { id: 'cloud-inversion', fa: 'fa-mountain-sun', editorNative: true, presets: [
            ...
            { id: 'blue-hour-env', fa: 'fa-cloud-moon', editorNative: true, presets: [
            ...
            { id: 'ultra-wide', fa: 'fa-expand', editorNative: true, presets: [
            ...
            { id: 'dslr-portra', fa: 'fa-camera', editorNative: true, isNew: true, presets: [
            ...
            { id: 'window-shadow', fa: 'fa-border-all', editorNative: true, isNew: true, presets: [
        ...
        function buildSidebar() {
            ...
            const SECTION_BEFORE = { 'cloud-inversion': 'nav.section-editing', custom: 'nav.section-studio' };
            CATEGORIES.forEach(cat => {
                if (SECTION_BEFORE[cat.id]) {
                    const label = document.createElement('p');
                    label.className = 'text-[0.7rem] font-bold uppercase tracking-wider px-3 mt-4 mb-1';
                    label.style.color = 'var(--muted)';
                    label.dataset.i18n = SECTION_BEFORE[cat.id];
        ...
        function buildPanels() {
            ...
            CATEGORIES.forEach(cat => {
                ...
                const single = cat.presets.length === 1;
                const presetSection = isCustom ? '' : `
                    <div class="card p-5">
                        ${stepHead(nPreset, single ? 'wiz.step-extra' : 'wiz.step2')}
                        <div id="${cat.id}-preset-grid" class="grid grid-cols-1 sm:grid-cols-2 gap-2${single ? ' hidden' : ''}">
                        ...
                        <div class="${single ? '' : 'mt-4'}">
                            ${single ? '' : '<p class="text-sm font-semibold mb-2" style="color:var(--muted)" data-i18n="wiz.custom-label"></p>'}
