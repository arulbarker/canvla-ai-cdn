...
(function () {
  ...
  function showError(msg) {
    document.body.innerHTML =
      ...
      + '<h2 style="margin:0 0 12px">Gagal memuat app / Failed to load</h2>'
      + '<pre style="white-space:pre-wrap;word-break:break-word">' + (msg || 'Error tidak diketahui / Unknown error') + '</pre>'
      + '<p style="margin-top:16px;opacity:.7">Buka DevTools console untuk detail teknis. / Open the DevTools console for details.</p>'
      + '</div>';
  }
